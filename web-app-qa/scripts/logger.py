"""
Logger - Standardized console output
Part of web-app-qa skill for Claude Skills

Provides consistent, colored console output for all scripts.
"""
...
if __name__ == '__main__':
    ...
    logger.section("Test Results", '=', 60)

    logger.table_row(['Browser', 'Status', 'Time'], [15, 10, 10])
    logger.table_row(['Chrome', 'PASS', '1.2s'], [15, 10, 10])
    logger.table_row(['Firefox', 'PASS', '2.1s'], [15, 10, 10])

    print()
    for i in range(101):
        logger.progress(i, 100, prefix='Progress:', suffix='Complete')
        import time
        time.sleep(0.02)
